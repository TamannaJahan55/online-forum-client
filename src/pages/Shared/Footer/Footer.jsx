...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-indigo-300 text-base-content">
            <aside>
                ...
                Dialogue Forum <br />Connecting Minds Online, Fostering Discussions Across the Virtual Realm. 
                </p>
